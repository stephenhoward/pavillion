...
- **Library:** activitypub-express 4.4+ (federated social protocols)
- **Authentication:** HTTP signatures for federation
- **Transport:** JSON-LD over HTTPS
...
- **Domain:** Stable domain name required for ActivityPub
- **HTTPS:** Required for ActivityPub federation
- **Webfinger:** Implemented for user discovery
- **HTTP Signatures:** For secure federated requests
...
### Why Vue.js 3?
- Excellent TypeScript integration with Composition API
- Lightweight and performant for calendar interfaces
- Strong ecosystem for internationalization
- Good server-side rendering support for public pages

### Why Express.js over Rails?
- Better real-time features for federation
- Easier ActivityPub integration with Node.js ecosystem
- Shared language (TypeScript) between frontend and backend
- More flexible for custom federation protocols

### Why Sequelize?
- Mature TypeScript support with decorators
- Good PostgreSQL feature support
- Handles complex relationships in calendar/event data
- Migration system for database evolution

### Why ActivityPub?
- W3C standard for federated social applications
- Enables calendar sharing across instances
- Future-proof protocol for social features
- Rich ecosystem of compatible applications

### Dual Application Architecture
- **Client App**: Full-featured authenticated interface
- **Site App**: Lightweight public calendar viewer
- **Shared Code**: Common models and utilities in `/common`
- **Clear Separation**: Prevents public/private code mixing

---

*This tech stack is specifically designed for the Pavillion federated events calendar system and should be maintained consistently across all development environments.*
