---
name: epic-bead-workflow
description: Patterns for working with epics and beads via the bd CLI. Use this skill when mapping bead dependencies, creating or splitting an epic, or driving any multi-bead workflow through the bd task-management system.
---
