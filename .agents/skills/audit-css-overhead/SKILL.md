...
```bash
.agents/skills/audit-css-overhead/find-css-overhead.sh [scope...]
```

`scope` is one or more paths. Defaults to `src/client` and `src/site`. Examples:

```bash
.agents/skills/audit-css-overhead/find-css-overhead.sh
.agents/skills/audit-css-overhead/find-css-overhead.sh src/client/components/admin
.agents/skills/audit-css-overhead/find-css-overhead.sh src/client/components/logged_in/calendar-management/import-sources
```
