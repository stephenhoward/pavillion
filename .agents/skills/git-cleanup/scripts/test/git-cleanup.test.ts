/**
 * Unit tests for .agents/skills/git-cleanup/scripts/lib/git-cleanup.ts
 *
...
describe('worktreeFamily', () => {
  ...
  // `.claude` is a symlink to `.agents`, so a realpath-resolved agent
  // worktree reports the `.agents` spelling of the same directory.
  it('classifies the .agents spelling of an agent worktree', () => {
    expect(worktreeFamily('/Users/x/repo/.agents/worktrees/agent-a1')).toBe('agent');
  });
