 ...
 *
 * Usage:
 *   npx tsx .agents/skills/git-cleanup/scripts/git-cleanup.ts classify
 *   npx tsx .agents/skills/git-cleanup/scripts/git-cleanup.ts execute --categories=merged-ancestor,merged-pr,empty,superseded \
 *       --worktree-families=superset,agent,chain --plan-id=<id from classify output>
 *   npx tsx .agents/skills/git-cleanup/scripts/git-cleanup.ts execute --branches=old-a,old-b --plan-id=<id>
 *
 * Operator-facing flow: .agents/skills/git-cleanup/SKILL.md
 */
