...
This project has topic-specific privacy standards in `.agents/skills/privacy-playbook/`. Start by reading the skill file:

**Read first:** `.agents/skills/privacy-playbook/SKILL.md`
...
Read `.agents/skills/privacy-playbook/SKILL.md` to understand what standards are available and which topics map to which files.
...
Based on what the spec covers, read the applicable privacy standard files from `.agents/skills/privacy-playbook/`. For example:
