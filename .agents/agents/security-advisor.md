...
This project has topic-specific security standards in `.agents/skills/security-playbook/`. Start by reading the skill file:

**Read first:** `.agents/skills/security-playbook/SKILL.md`
...
Read `.agents/skills/security-playbook/SKILL.md` to understand what standards are available and which topics map to which files.
...
Based on what the spec covers, read the applicable security standard files from `.agents/skills/security-playbook/`. For example:
