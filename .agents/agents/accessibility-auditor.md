...
This project enforces accessibility standards documented in `.agents/skills/frontend-accessibility/accessibility.md`. Read that file at the start of every audit for the authoritative patterns.
...
Read `.agents/skills/frontend-accessibility/accessibility.md` to ensure you're using the current project patterns as your baseline.
...
4. Screen Reader Walk-Through (VSR):
   ...
   The expected announcement shapes for the project's common patterns are documented in `.agents/skills/frontend-accessibility/accessibility.md` § Expected Screen Reader Announcements. Compare your captured log against that table to surface deviations.
...
7. **Cross-reference the project standards.** Read `.agents/skills/frontend-accessibility/accessibility.md` and use those patterns as the expected baseline.
