...
- **Implementation blocker** — surface to user: retry with adjusted approach, spawn research subagent, escalate via `npx tsx .agents/tools/bead.ts escalate <id> "<reason>"`, or skip if it doesn't block other work.
