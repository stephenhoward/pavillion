...
Read `.agents/skills/standards-routing/index.yml` if it exists. Note which entries already have descriptions.
...
Generate `.agents/skills/standards-routing/index.yml` with this structure:
...
Updates `.agents/skills/standards-routing/index.yml`
