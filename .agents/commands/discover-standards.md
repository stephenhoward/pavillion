...
1. Determine the appropriate skill name. Check if a related skill already exists in `.agents/skills/`:
...
2. For a **new skill**, create both files:
   - `.agents/skills/<skill-name>/SKILL.md` — with frontmatter description
   - `.agents/skills/<skill-name>/<standard-name>.md` — the standard content
...
```
Here's the draft for .agents/skills/backend-api/response-format.md:
...
5. Create or update the file in `.agents/skills/<skill-name>/`
...
1. Scan `.agents/skills/` for all directories and their `.md` files (excluding SKILL.md)
...
3. Update `.agents/skills/standards-routing/index.yml`:
...
- .agents/skills/backend-api/response-format.md
- .agents/skills/global-error-handling/error-codes.md
...
All standards: `.agents/skills/<skill-name>/<standard>.md`
Index file: `.agents/skills/standards-routing/index.yml`
...
```
Here's the draft for .agents/skills/backend-api/response-envelope.md:
