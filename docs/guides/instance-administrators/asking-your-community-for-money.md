...
- The voice question: warmth, not desperation; gratitude, not entitlement; honesty about what contributions buy (continued operation) and what they don't (special treatment, priority for anyone's events, anything that resembles a tier). The extended features supporters unlock are a bounded thank-you — bridges to non-federated systems, never the community features themselves — and the ask should frame them that way
...
- A short list of don'ts, with reasons: don't gate community features behind contributions (the federated value boundary decides what's gated, and it's never the in-network features), don't email people who contributed once asking for more, don't hide the "no thanks" option, don't sell the contribution as anything other than what it is
