...
<template>
    <modal-layout :title="t('select_language')">
    <div class="languages" :dir="iso6391.getDir(defaultLanguage) == 'rtl' ? 'rtl' : ''">
        <input type="search" :placeholder="t('search_language')" v-model="state.searchString" @keyup="filterLanguages()" @search="filterLanguages()" />
        <ul>
