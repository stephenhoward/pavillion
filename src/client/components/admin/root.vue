...
const navItems = [
  ...
  { id: 'calendars', routeName: 'admin_calendars', path: '/admin/calendars', labelKey: 'calendars_link' },
  { id: 'moderation', routeName: 'moderation', path: '/admin/moderation', labelKey: 'moderation' },
