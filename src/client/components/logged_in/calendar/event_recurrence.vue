...
.recurrence-rule {
  ...
  // .repeats form styles moved to shared partial:
  //   src/client/assets/style/components/_recurrence-form.scss
  // Registered globally via main.scss so both this inline form and the future
  // RecurrenceEditorSheet.vue consumer render from a single source of truth.
