...
import { EmailMessage, compileTemplate } from '../model/message';
import { MailData } from '../model/types';
import { initI18Next } from '@/server/common/test/lib/i18next';

initI18Next();

/**
 * Tests for EmailMessage abstract class template rendering
 *
 * These tests verify:
 * - Template compilation with Handlebars
 * - i18n integration for subjects
 * - Plaintext and HTML rendering
 */
