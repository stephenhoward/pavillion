...
describe('EventInstanceService sourceCalendar resolution', () => {
  ...
  describe('URL parsing edge cases', () => {
    it('should parse attributed_to with trailing slash', async () => {
      const instanceEntity = buildMockInstanceEntity({
        instanceId: 'inst-8',
        instanceCalendarId: 'cal-B',
        eventId: 'evt-8',
    ...
    it('should handle malformed attributed_to gracefully', async () => {
      const instanceEntity = buildMockInstanceEntity({
        instanceId: 'inst-9',
        instanceCalendarId: 'cal-B',
        eventId: 'evt-9',
    ...
    it('should handle attributed_to without /calendars/ path', async () => {
      const instanceEntity = buildMockInstanceEntity({
        instanceId: 'inst-10',
        instanceCalendarId: 'cal-B',
        eventId: 'evt-10',
      ...
      sandbox.stub(EventObjectEntity, 'findAll').resolves([
        {
          event_id: 'evt-10',
          attributed_to: 'https://remote.example.com/actors/some-actor',
        } as any,
      ]);
