...
Read `.claude/skills/standards-routing/index.yml` to get the list of available standards and their descriptions.
...
@.claude/skills/backend-api/api.md
@.claude/skills/global-error-handling/error-handling.md
@.claude/skills/global-conventions/conventions.md
...
Arguments can be:
- **Skill name** — `backend-api` → inject all `.md` files in `.claude/skills/backend-api/` (except SKILL.md)
- **Skill/file** — `backend-api/api` → inject `.claude/skills/backend-api/api.md`
...
Available files in .claude/skills/backend-api/:
- api.md
